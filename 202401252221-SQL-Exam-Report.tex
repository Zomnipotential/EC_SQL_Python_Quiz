...
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=north west, inner sep=0pt] at ([xshift=5pt, yshift=-300pt] current page.north west) {\includegraphics[width=240pt]{img_order_quantity.png}};
\end{tikzpicture}
\fi
...
\if(x)
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=north west, inner sep=0pt] at ([xshift=400pt, yshift=-9.0in] current page.north west) {\includegraphics[width=120pt]{img_yearly_income.png}};
\end{tikzpicture}
\fi
