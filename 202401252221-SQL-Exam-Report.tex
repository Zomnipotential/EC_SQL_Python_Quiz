...
\begin{tikzpicture}[baseline=(current bounding box.north)]
    \node[anchor=north west, inner sep=0pt]  at (0,0) {\includegraphics[width=\textwidth]{img_boxplot.png}};
\end{tikzpicture}
\fi
...
\if(x)
\begin{tikzpicture}[remember picture,overlay]
    \node[anchor=north west, inner sep=0pt] at ([xshift=2.3in, yshift=-4.4in] current page.north west) {\includegraphics[width=0.7\textwidth]{img_gender_total_purchase_ytd.png}};
\end{tikzpicture}\\\\\\\\
\fi
